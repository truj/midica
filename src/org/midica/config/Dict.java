...
public class Dict {
	...
	public static final String CONF_COL_SYNTAX_DESC        = "conf_col_syntax_desc";
	public static final String CONF_COL_SYNTAX_SHORTCUT    = "conf_col_syntax_shortcut";
	public static final String CONF_COL_PERC_NUM           = "conf_col_perc_num";
	public static final String CONF_COL_PERC_NAME          = "conf_col_perc_name";
	public static final String CONF_COL_INSTR_NUM          = "conf_col_instr_num";
	public static final String CONF_COL_INSTR_NAME         = "conf_col_instr_name";
	...
	private static void initLanguageEnglish() {
		...
		set( CONF_COL_SYNTAX_DESC,                   "Description"                  );
		set( CONF_COL_SYNTAX_SHORTCUT,               "Keyword"                      );
		set( CONF_COL_PERC_NUM,                      "Number"                       );
		set( CONF_COL_PERC_NAME,                     "Name"                         );
		set( CONF_COL_INSTR_NUM,                     "Number"                       );
		set( CONF_COL_INSTR_NAME,                    "Name"                         );
