...
public class Dict {
	...
	public static final String SYNTAX_PL_DOT             = "PL_DOT";
	public static final String SYNTAX_PL_KEEP            = "PL_KEEP";
	public static final String SYNTAX_PL_DOUBLE          = "PL_DOUBLE";
	public static final String SYNTAX_PL_CTRL            = "PL_CTRL";
	public static final String SYNTAX_PL_RPN             = "PL_RPN";
	public static final String SYNTAX_PL_NRPN            = "PL_NRPN";
	public static final String SYNTAX_PL_ASSIGNER        = "PL_ASSIGNER";
	...
	public static final String SYNTAX_FUNC_LINE          = "FUNC_LINE";
	public static final String SYNTAX_FUNC_SIN           = "FUNC_SIN";
	public static final String SYNTAX_FUNC_COS           = "FUNC_COS";
	public static final String SYNTAX_FUNC_NSIN          = "FUNC_NSIN";
	public static final String SYNTAX_FUNC_NCOS          = "FUNC_NCOS";
	...
	public static final String SYNTAX_CC_01_MOD          = "CC_01_MOD";
	public static final String SYNTAX_CC_02_BREATH       = "CC_02_BREATH";
	public static final String SYNTAX_CC_04_FOOT         = "CC_04_FOOT";
	public static final String SYNTAX_CC_05_PORT_TIME    = "CC_05_PORT_TIME";
	public static final String SYNTAX_CC_08_BALANCE      = "CC_08_BALANCE";
	public static final String SYNTAX_CC_0A_PAN          = "CC_0A_PAN";
	public static final String SYNTAX_CC_0B_EXPRESSION   = "CC_0B_EXPRESSION";
	public static final String SYNTAX_CC_0C_EFFECT_1     = "CC_0C_EFFECT_1";
	public static final String SYNTAX_CC_0D_EFFECT_2     = "CC_0D_EFFECT_2";
	public static final String SYNTAX_CC_40_HOLD_1       = "CC_40_HOLD_1"; // same as DAMPER
	public static final String SYNTAX_CC_41_PORTAMENTO   = "CC_41_PORTAMENTO";
	public static final String SYNTAX_CC_42_SOSTENUTO    = "CC_42_SOSTENUTO";
	public static final String SYNTAX_CC_43_SOFT         = "CC_43_SOFT";
	public static final String SYNTAX_CC_44_LEGATO       = "CC_44_LEGATO";
	public static final String SYNTAX_CC_45_HOLD_2       = "CC_45_HOLD_2";
	public static final String SYNTAX_CC_46_SC1_VAR      = "CC_46_SC1_VAR";
	public static final String SYNTAX_CC_47_SC2_TIMB     = "CC_47_SC2_TIMB";
	public static final String SYNTAX_CC_48_SC3_REL_T    = "CC_48_SC3_REL_T";
	public static final String SYNTAX_CC_49_SC4_ATT_T    = "CC_49_SC4_ATT_T";
	public static final String SYNTAX_CC_4A_SC5_BRI      = "CC_4A_SC5_BRI";
	public static final String SYNTAX_CC_4B_SC6_DEC_T    = "CC_4B_SC6_DEC_T";
	public static final String SYNTAX_CC_4C_SC7_VIB_R    = "CC_4C_SC7_VIB_R";
	public static final String SYNTAX_CC_4D_SC8_VIB_DP   = "CC_4D_SC8_VIB_DP";
	public static final String SYNTAX_CC_4E_SC9_VIB_DL   = "CC_4E_SC9_VIB_DL";
	public static final String SYNTAX_CC_54_PORTAMENTO   = "CC_54_PORTAMENTO";
	public static final String SYNTAX_CC_5B_EFF1_DEP     = "CC_5B_EFF1_DEP";
	public static final String SYNTAX_CC_5C_EFF2_DEP     = "CC_5C_EFF2_DEP";
	...
	public static final String SYNTAX_CAT_SND_EFFECT       = "syntax_cat_snd_effect";
	...
	private static void initLanguageEnglish() {
		...
		set( SYNTAX_CAT_SND_EFFECT,                  "Sound Effects"                 );
		...
		set( SYNTAX_PL_DOT,             "separator between pipeline elements (controller, function name, etc.)" );
		set( SYNTAX_PL_KEEP,            "keep function value after function ends (pipeline element)" );
		set( SYNTAX_PL_DOUBLE,          "use double precision (pipeline element)"         );
		set( SYNTAX_PL_CTRL,            "Generic Controller (pipeline element)"           );
		set( SYNTAX_PL_RPN,             "Generic RPN (pipeline element)"                  );
		set( SYNTAX_PL_NRPN,            "Generic NRPN (pipeline element)"                 );
		set( SYNTAX_PL_ASSIGNER,        "asssigner for pipeline elements, e.g. Ctrl/(N)RPN number or note name" );
		...
		set( SYNTAX_FUNC_LINE,          "linear function"                                 );
		set( SYNTAX_FUNC_SIN,           "sine function"                                   );
		set( SYNTAX_FUNC_COS,           "cosine function"                                 );
		set( SYNTAX_FUNC_NSIN,          "negative sine function"                          );
		set( SYNTAX_FUNC_NCOS,          "negative cosine function"                        );
		...
		set( SYNTAX_CC_05_PORT_TIME,    "Controller 5 (0x05): Portamento Time"            );
		set( SYNTAX_CC_08_BALANCE,      "Controller 8 (0x08): Balance (Stereo)"           );
		set( SYNTAX_CC_0A_PAN,          "Controller 10 (0x0A): Panorama (Stereo)"         );
		set( SYNTAX_CC_0B_EXPRESSION,   "Controller 11 (0x0B): Expression (Volume)"       );
		set( SYNTAX_CC_0C_EFFECT_1,     "Controller 12 (0x0C): Effect Controller 1"       );
		set( SYNTAX_CC_0D_EFFECT_2,     "Controller 13 (0x0D): Effect Controller 2"       );
		set( SYNTAX_CC_40_HOLD_1,       "Controller 64 (0x40): Hold/Sustain/Damper Pedal" );
		set( SYNTAX_CC_41_PORTAMENTO,   "Controller 65 (0x41): Portamento Pedal"          );
		set( SYNTAX_CC_42_SOSTENUTO,    "Controller 66 (0x42): Sostenuto Pedal"           );
		set( SYNTAX_CC_43_SOFT,         "Controller 67 (0x43): Soft Pedal"                );
		set( SYNTAX_CC_44_LEGATO,       "Controller 68 (0x44): Legato Pedal"              );
		set( SYNTAX_CC_45_HOLD_2,       "Controller 69 (0x45): Second Hold Pedal"         );
		set( SYNTAX_CC_46_SC1_VAR,      "Controller 70 (0x46): Sound Controller 1 (Variation)"       );
		set( SYNTAX_CC_47_SC2_TIMB,     "Controller 71 (0x47): Sound Controller 2 (Timbre/Harmonic)" );
		set( SYNTAX_CC_48_SC3_REL_T,    "Controller 72 (0x48): Sound Controller 3 (Release Time)"    );
		set( SYNTAX_CC_49_SC4_ATT_T,    "Controller 73 (0x49): Sound Controller 4 (Attack Time)"     );
		set( SYNTAX_CC_4A_SC5_BRI,      "Controller 74 (0x4A): Sound Controller 5 (Brightness)"      );
		set( SYNTAX_CC_4B_SC6_DEC_T,    "Controller 75 (0x4B): Sound Controller 6 (Decay Time)"      );
		set( SYNTAX_CC_4C_SC7_VIB_R,    "Controller 76 (0x4C): Sound Controller 7 (Vibrato Rate)"    );
		set( SYNTAX_CC_4D_SC8_VIB_DP,   "Controller 77 (0x4D): Sound Controller 8 (Vibrato Depth)"   );
		set( SYNTAX_CC_4E_SC9_VIB_DL,   "Controller 78 (0x4E): Sound Controller 9 (Vibrato Delay)"   );
		set( SYNTAX_CC_54_PORTAMENTO,   "Controller 84 (0x54): Portamento Control"              );
		set( SYNTAX_CC_5B_EFF1_DEP,     "Controller 91 (0x5B): Effect 1 Depth (Reverb/Delay)"   );
		set( SYNTAX_CC_5C_EFF2_DEP,     "Controller 92 (0x5C): Effect 2 Depth (Tremolo)"        );
	...
	public static void initSyntax() {
		...
		setSyntax( SYNTAX_PL_DOT,              "."            );
		setSyntax( SYNTAX_PL_KEEP,             "keep"         );
		setSyntax( SYNTAX_PL_DOUBLE,           "double"       );
		setSyntax( SYNTAX_PL_CTRL,             "ctrl"         );
		setSyntax( SYNTAX_PL_RPN,              "rpn"          );
		setSyntax( SYNTAX_PL_NRPN,             "nrpn"         );
		setSyntax( SYNTAX_PL_ASSIGNER,         "="            );
		...
		setSyntax( SYNTAX_CC_08_BALANCE,       "balance"      );
		setSyntax( SYNTAX_CC_0A_PAN,           "pan"          );
		setSyntax( SYNTAX_CC_0B_EXPRESSION,    "vol"          );
		setSyntax( SYNTAX_CC_0C_EFFECT_1,      "ec1"          );
		setSyntax( SYNTAX_CC_0D_EFFECT_2,      "ec2"          );
		setSyntax( SYNTAX_CC_40_HOLD_1,        "hold"         );
		setSyntax( SYNTAX_CC_41_PORTAMENTO,    "port"         );
		setSyntax( SYNTAX_CC_42_SOSTENUTO,     "sost"         );
		setSyntax( SYNTAX_CC_43_SOFT,          "soft"         );
		setSyntax( SYNTAX_CC_44_LEGATO,        "legato"       );
		setSyntax( SYNTAX_CC_45_HOLD_2,        "hold2"        );
		setSyntax( SYNTAX_CC_46_SC1_VAR,       "var"          );
		setSyntax( SYNTAX_CC_47_SC2_TIMB,      "timbre"       );
		setSyntax( SYNTAX_CC_48_SC3_REL_T,     "rel_time"     );
		setSyntax( SYNTAX_CC_49_SC4_ATT_T,     "att_time"     );
		setSyntax( SYNTAX_CC_4A_SC5_BRI,       "brightness"   );
		setSyntax( SYNTAX_CC_4B_SC6_DEC_T,     "decay_time"   );
		setSyntax( SYNTAX_CC_4C_SC7_VIB_R,     "vibr_rate"    );
		setSyntax( SYNTAX_CC_4D_SC8_VIB_DP,    "vibr_depth"   );
		setSyntax( SYNTAX_CC_4E_SC9_VIB_DL,    "vibr_delay"   );
		setSyntax( SYNTAX_CC_54_PORTAMENTO,    "port_ctrl"    );
		setSyntax( SYNTAX_CC_5B_EFF1_DEP,      "reverb"       );
		setSyntax( SYNTAX_CC_5C_EFF2_DEP,      "tremolo"      );
		...
		addSyntaxForInfoView( SYNTAX_PL_DOT             );
		addSyntaxForInfoView( SYNTAX_PL_KEEP            );
		addSyntaxForInfoView( SYNTAX_PL_DOUBLE          );
		addSyntaxForInfoView( SYNTAX_PL_CTRL            );
		addSyntaxForInfoView( SYNTAX_PL_RPN             );
		addSyntaxForInfoView( SYNTAX_PL_NRPN            );
		addSyntaxForInfoView( SYNTAX_PL_ASSIGNER        );
		addSyntaxForInfoView( SYNTAX_FUNC_SET           );
		addSyntaxForInfoView( SYNTAX_FUNC_ON            );
		addSyntaxForInfoView( SYNTAX_FUNC_OFF           );
		addSyntaxForInfoView( SYNTAX_FUNC_LINE          );
		addSyntaxForInfoView( SYNTAX_FUNC_SIN           );
		addSyntaxForInfoView( SYNTAX_FUNC_COS           );
		addSyntaxForInfoView( SYNTAX_FUNC_NSIN          );
		addSyntaxForInfoView( SYNTAX_FUNC_NCOS          );
		...
		addSyntaxForInfoView( SYNTAX_CC_01_MOD          );
		addSyntaxForInfoView( SYNTAX_CC_02_BREATH       );
		addSyntaxForInfoView( SYNTAX_CC_04_FOOT         );
		addSyntaxForInfoView( SYNTAX_CC_05_PORT_TIME    );
		addSyntaxForInfoView( SYNTAX_CC_08_BALANCE      );
		addSyntaxForInfoView( SYNTAX_CC_0A_PAN          );
		addSyntaxForInfoView( SYNTAX_CC_0B_EXPRESSION   );
		addSyntaxForInfoView( SYNTAX_CC_0C_EFFECT_1     );
		addSyntaxForInfoView( SYNTAX_CC_0D_EFFECT_2     );
		addSyntaxForInfoView( SYNTAX_CC_40_HOLD_1       );
		addSyntaxForInfoView( SYNTAX_CC_41_PORTAMENTO   );
		addSyntaxForInfoView( SYNTAX_CC_42_SOSTENUTO    );
		addSyntaxForInfoView( SYNTAX_CC_43_SOFT         );
		addSyntaxForInfoView( SYNTAX_CC_44_LEGATO       );
		addSyntaxForInfoView( SYNTAX_CC_45_HOLD_2       );
		addSyntaxForInfoView( SYNTAX_CC_46_SC1_VAR      );
		addSyntaxForInfoView( SYNTAX_CC_47_SC2_TIMB     );
		addSyntaxForInfoView( SYNTAX_CC_48_SC3_REL_T    );
		addSyntaxForInfoView( SYNTAX_CC_49_SC4_ATT_T    );
		addSyntaxForInfoView( SYNTAX_CC_4A_SC5_BRI      );
		addSyntaxForInfoView( SYNTAX_CC_4B_SC6_DEC_T    );
		addSyntaxForInfoView( SYNTAX_CC_4C_SC7_VIB_R    );
		addSyntaxForInfoView( SYNTAX_CC_4D_SC8_VIB_DP   );
		addSyntaxForInfoView( SYNTAX_CC_4E_SC9_VIB_DL   );
		addSyntaxForInfoView( SYNTAX_CC_54_PORTAMENTO   );
		addSyntaxForInfoView( SYNTAX_CC_5B_EFF1_DEP     );
		addSyntaxForInfoView( SYNTAX_CC_5C_EFF2_DEP     );
